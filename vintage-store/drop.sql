    ...
    drop table if exists PanacheMyEntity cascade;
    ...
    drop sequence if exists PanacheMyEntity_SEQ;

    drop sequence if exists t_customers_SEQ;

    drop sequence if exists t_items_SEQ;

    drop sequence if exists t_publishers_SEQ;

    drop sequence if exists t_purchase_order_lines_SEQ;

    drop sequence if exists t_purchase_orders_SEQ;

    drop sequence if exists t_tracks_SEQ;
